...
Math.min(Math.max(Math.random(), 0), 1);

registerInterval(1, function() {
  setMaterialValue('Verge3D_Environment_World', 'Value', getMaterialValue('Verge3D_Environment_World', 'Value') + 0.05);
});
